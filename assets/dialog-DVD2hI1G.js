import{e as $,t as I,n as O,u as M,a as B,g as E,f as q,h as j,T as U,b as L}from"./index-doPZh83d.js";import{G as W,H as G,S as Y,p as z,a as V,y as P,x as d,n as b,E as x,g as H,h as u,d as f,c as Q}from"./vendor-YHmzau40.js";import"./claim-amhLY5Cc.js";const w=async(e=!1)=>q("MediaBoard",{account:e?void 0:await B()}),Z=async(e,t,s)=>{const i=await w(),r="vote",c={},n=[e,t,s];await $(c,i,r,n);const y=i[r](...n);return new I(y,{errorCodes:"MediaBoard",allowAlmostSuccess:!0,seq:{type:"VoteSubject",title:"Vote Subject",ts:O(),overrides:c}})},K=async e=>{try{const t=await w(!0),s="getSocials",i=[e];return(await t[s](...i))[0][2]}catch(t){console.log(t)}},X=async(e,t)=>{const s=await w(),i="retreat",r={},c=[e,t];await $(r,s,i,c);const n=s[i](...c);return new I(n,{errorCodes:"MediaBoard",allowAlmostSuccess:!0,seq:{type:"RetreatSubject",title:"Retreat Subject",ts:O(),overrides:r}})},tt=async e=>{const t=await w(!0),s="subjectToData",i={},r=[e];return await $(i,t,s,r),await t[s](...r)},et=async e=>M(e,await B()),st=async e=>{try{const t=await w(!0),s="getRetreatPrice",i=[e,1];return await t[s](...i)}catch{return 0}},it=async e=>{const t=await w(!0),s="getVotePrice",i=[e,1];return await t[s](...i)},rt=async e=>{const t=await w(!0),s="getVotePriceWithFee",i={},r=[e,1];return await $(i,t,s,r),await t[s](...r)},ft=async(e,t)=>{const s=24n*60n*60n;let i=BigInt(new Date().getTime())/1000n-s,r=`{
    ...
    }`;return await E("MediaBoard",r)},vt=async e=>{const t=24n*60n*60n;let s=BigInt(new Date().getTime())/1000n-t,i=`{
    ...
    }`;return await E("MediaBoard",i)};var T={exports:{}};(function(e,t){(function(s,i){i(t,e)})(W,function(s,i){var r={timeout:5e3,jsonpCallback:"callback",jsonpCallbackFunction:null};function c(){return"jsonp_"+Date.now()+"_"+Math.ceil(Math.random()*1e5)}function n(h){try{delete window[h]}catch{window[h]=void 0}}function y(h){var l=document.getElementById(h);l&&document.getElementsByTagName("head")[0].removeChild(l)}function F(h){var l=arguments.length<=1||arguments[1]===void 0?{}:arguments[1],S=h,N=l.timeout||r.timeout,D=l.jsonpCallback||r.jsonpCallback,g=void 0;return new Promise(function(R,_){var m=l.jsonpCallbackFunction||c(),v=D+"_"+m;window[m]=function(J){R({ok:!0,json:function(){return Promise.resolve(J)}}),g&&clearTimeout(g),y(v),n(m)},S+=S.indexOf("?")===-1?"?":"&";var p=document.createElement("script");p.setAttribute("src",""+S+D+"="+m),l.charset&&p.setAttribute("charset",l.charset),l.nonce&&p.setAttribute("nonce",l.nonce),l.referrerPolicy&&p.setAttribute("referrerPolicy",l.referrerPolicy),l.crossorigin&&p.setAttribute("crossorigin","true"),p.id=v,document.getElementsByTagName("head")[0].appendChild(p),g=setTimeout(function(){_(new Error("JSONP request to "+h+" timed out")),n(m),y(v),window[m]=function(){n(m)}},N),p.onerror=function(){_(new Error("JSONP request to "+h+" failed")),n(m),y(v),g&&clearTimeout(g)}})}i.exports=F})})(T,T.exports);var at=T.exports;const ot=G(at);var ct=Object.defineProperty,nt=Object.getOwnPropertyDescriptor,lt=(e,t,s,i)=>{for(var r=i>1?void 0:i?nt(t,s):t,c=e.length-1,n;c>=0;c--)(n=e[c])&&(r=(i?n(t,s,r):n(r))||r);return i&&r&&ct(t,s,r),r};const ut=async e=>{let t;if(e)try{t=await(await ot("https://publish.twitter.com/oembed?url="+encodeURIComponent(e))).json()}catch{}return t},dt=async e=>{const{author_name:t="",author_url:s="",html:i=""}=await ut(e)??{};if(t)return{name:t,url:s,id:(s.match(/([^/]+?)$/)??[])[1]??"",address:(i.match(/(0x([a-zA-Z0-9]+)?)/)??[])[1]??""}};class A extends Y{constructor(){super(),this.key="",this.sync=()=>{let t=JSON.parse(j.getItem(this.key)||"{}");new Date().getTime()<1704798753768&&(j.removeItem(this.key),t={}),this.tweets=t},this.save=()=>{this.tweets={...this.tweets},j.setItem(this.key,JSON.stringify(this.tweets),86400*7*1e3)},this.set=(t,s)=>{this.tweets[t]=s,this.save()},this.key="tweets",this.sync()}async get(t){let s=this.tweets[t];return s||(s=await dt(t),s&&this.set(t,s)),s}}lt([z({value:{}})],A.prototype,"tweets",2);const k=new A;var ht=Object.defineProperty,mt=Object.getOwnPropertyDescriptor,o=(e,t,s,i)=>{for(var r=i>1?void 0:i?mt(t,s):t,c=e.length-1,n;c>=0;c--)(n=e[c])&&(r=(i?n(t,s,r):n(r))||r);return i&&r&&ht(t,s,r),r};const C=()=>({tx:""});let a=class extends U(""){constructor(){super(...arguments),this.bindBridge=new V(this,L),this.bindTweets=new V(this,k),this.album="",this.url="",this.name="",this.author="",this.myVotes=0,this.retreatPrice=0,this.retreatDisabled=!0,this.socialName="",this.socialURI="",this.socialID="",this.socialVerified=!1,this.tx=null,this.success=!1,this.pending=!1,this.rewards=!1,this.err=C(),this.ts=0,this.resetState=()=>{this.err=C(),this.pending=!1,this.success=!1,this.price=void 0,this.votes=void 0},this.close=async()=>{this.tx=null,this.resetState(),this.emit("close")},this.updateErr=(e={})=>this.err=Object.assign({},this.err,e)}async connectedCallback(){super.connectedCallback(),await this.getPrice(),await this.readFromTwitter(),this.ts++}get hasVoted(){return this.ts&&+P(this.myVotes,1)>0}async readFromTwitter(){const e=await K(this.author),t=await k.get(e);this.socialName=t.author_name,this.socialURI=t.author_url,this.socialID=t.author_url.substring(t.author_url.lastIndexOf("/")+1,t.author_url.length-1),this.socialVerified=t.html.includes(this.author),this.socialVerified=!0}async getPrice(){try{this.votes=tt(this.album).then(e=>e[4]),this.myVotes=await et(this.album).then(e=>(e>0&&(this.retreatDisabled=!1),e)),this.price=it(this.album).then(e=>P(e,18)),this.retreatPrice=await st(this.album).then(e=>P(e,18))}catch(e){let t=e.message||e.code;this.updateErr({tx:t})}}async vote(){this.pending=!0;try{this.tx=await Z(this.album,1,{value:(await rt(this.album))[0]}),this.success=await this.tx.wait()}catch(e){this.tx||(this.tx={},this.tx.status=0,this.tx.err=e)}}async retreat(){this.pending=!0;try{this.tx=await X(this.album,1),this.success=await this.tx.wait()}catch(e){this.tx||(this.tx={},this.tx.status=0,this.tx.err=e)}}render(){return d`<ui-dialog
      @close=${()=>{this.close()}}
    >
