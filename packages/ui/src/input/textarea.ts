...
export class UIInputTextarea extends ThemeElement(style) {
  ...
  render() {
    return html`<div
      class="ui-input-text ui-input-textarea ${classMap(this.$c([this.class, { sm: this.sm, dense: this.dense }]))}"
